...
import com.springExec.board.config.TestSecurityConfig;
import com.springExec.board.controller.ArticleController;
import com.springExec.board.domain.constant.FormStatus;
...
import com.springExec.board.request.ArticleRequest;
...
import com.springExec.board.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @Test
    @DisplayName("[view][GET] 게시글 해시태그 검색 - 정상호출, 해시태그 없이")
    ...
    @DisplayName("[view][POST] 새 게시글 등록 - 정상 호출, 인증된 사용자")
    @Test
    ...
    @WithUserDetails(value = "unoTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @DisplayName("[view][POST] 게시글 삭제 - 정상 호출, 인증된 사용자")
    @Test
